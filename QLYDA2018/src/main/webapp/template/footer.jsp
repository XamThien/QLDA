	...
	<!-- =================================================================================================-->
			...
			<!-- =================================================================================================-->
			<script src="/resources/vendors/jquery/dist/jquery.min.js" type="text/javascript"></script>
			
		    <!-- Bootstrap ${pageContext.request.contextPath} -->
		    ...
		    <!-- ECharts -->
		    <script src="/resources/vendors/echarts/dist/echarts.min.js"></script>
		    <script src="/resources/vendors/echarts/map/js/world.js"></script>
		    ...
		    <script src="/resources/build/js/qlda2018.js"></script>
