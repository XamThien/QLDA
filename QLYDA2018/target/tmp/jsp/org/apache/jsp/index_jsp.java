 ...
 * Generated at: 2018-06-20 10:23:07 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<h2>Đây là nội dung trang chủ phần mền quản lý thư viên trường đại học xây dựng.</h2>\r\n");
      out.write("\t\t\t\t\t<br/>\r\n");
      out.write("\t\t\t\t\t<h2>Đây là nội dung trang chủ phần mền quản lý thư viên trường đại học xây dựng.</h2>\r\n");
      out.write("\t\t\t\t\t<br/>\r\n");
      out.write("\t\t\t\t\t<h2>Đây là nội dung trang chủ phần mền quản lý thư viên trường đại học xây dựng.</h2>\r\n");
      ...
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<h2>Đây là nội dung trang chủ phần mền quản lý thư viên trường đại học xây dựng.</h2>\r\n");
      out.write("\t\t\t\t\t<br/><h2>Đây là nội dung trang chủ phần mền quản lý thư viên trường đại học xây dựng.</h2>\r\n");
      out.write("\t\t\t\t\t<br/>\r\n");
      out.write("\t\t\t\t\t<h2>Đây là nội dung trang chủ phần mền quản lý thư viên trường đại học xây dựng.</h2>\r\n");
      out.write("\t\t\t\t\t<br/>\r\n");
      out.write("\t\t\t\t\t\r\n");
